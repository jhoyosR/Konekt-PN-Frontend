...
export class ProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.profileImagePreview =
      this.profile.profilePhotoUrl || this.profile.profilePhoto || null;
  ...
  //Metodo para los campos editables de cada rol
  ...
  //Metodo para determinar si la contraseña y el confirmar contraseña coinciden
  ...
  //Metodo para cargar todos los campos de cada rol
  ...
  //Metodo para capturar la foto de perfil seleccionada
  ...
  //Metodo para capturar la hoja de vida del estudiante seleccionada
          ...
          update$.subscribe({
            next: () => {
              refresh$.subscribe({
                next: (entity: any) => {
                  const photo =
                    entity.profilePhotoUrl || entity.profilePhoto || fileName;
  ...
  //Modal para actualizar la hoja de vida del estudiante
  updateResume(): void {
  ...
  //Metodo para abrir los campos para modificar la contraseña
  ...
  //Metodo para ocultar los campos de modificar la contraseña
  cancelPasswordChange(): void {
    this.passwordForm.reset();
    this.showPasswordForm = false;
    this.showPassword = false;
  }
  //Metodo para mostrar u ocultar la contraseña escrita
  togglePassword(): void {
    this.showPassword = !this.showPassword;
  }
  //Metodo para actualizar los datos del perfil según el rol
  updateProfile(): void {
